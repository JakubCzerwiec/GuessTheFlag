...
struct ContentView: View {
    ...
    let labels = [
        ...
        "UK": "Flag with overlaping red and white crosses, both straight and diagonally, on blue background",
        "Ukraine": "Flag with two horizontal stripes. Top stripe blue, bottom stripe gold",
        "US": "Flag with many red and white stripes, whit white stars in the top-left corner"
    ]
